...
int introspect_enter_PEMU(target_ulong syscall_op, target_ulong arg1, target_ulong arg2, target_ulong arg3, target_ulong arg4, target_ulong arg5, target_ulong arg6)
{
	char str[256];
				...
				//->EBX  ECX  EDX   ESI   EDI  EBP  
                        ...
                        case 192 : // sys_mmap2
								...
								{	
    							 ...
    							 sc_init(0x3);
								 size = regs[R_ECX];
                              	 insert_sc_arg(0, regs[R_EDI]&0xfff,  0, 0);
...
//	sys_need_redirect = 0;
	...
	else
	{
	    ...
	    int res = syscallori(syscall_op, arg1,arg2,arg3,arg4,arg5,arg6);
		if(syscall_op ==0x5)
		{
#ifdef DEBUG
			sprintf(str, "real open file %s %d \n", arg1, res);
	        syscallori(4,1, str, strlen(str)+1);
#endif

		}

							if(syscall_op==195 || syscall_op == 196)
							{
#ifdef DEBUG
							  sprintf(str, "real stat64 file %s %d %d\n", arg1, res, ENOENT);
							  syscallori(4,1, str, strlen(str)+1);
#endif
...
#ifdef DEBUG
							  sprintf(str, "real syscall return %d\n", res);
							  syscallori(4,1, str, strlen(str)+1);
#endif
							return res;
	}
